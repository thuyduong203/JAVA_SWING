...
public class ViewLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/ingDangNhap.jpg"))); // NOI18N
    ...
    private void btnDangNhapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDangNhapActionPerformed
        if (nhanVienService.getNV(txtMaNV.getText(), txtPass.getText())) {
            JOptionPane.showMessageDialog(this, "Đăng nhập thành công");
            DialogAssg viewAssg = new DialogAssg(this, rootPaneCheckingEnabled);
            this.dispose();
            viewAssg.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "Chịu");
        }
