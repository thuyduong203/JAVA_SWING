...
public class ViewNSX extends javax.swing.JFrame {
    ...
    public ViewNSX() {
        ...
        listNSX = nsxServiceImpl.getAllNSX();
        showData(listNSX);
    }
    
    private void showData(List<NSX> listNSX) {
        dtmNSX.setRowCount(0);
        List<NSXViewModel> listNSXView = nsxServiceImpl.convertOb(listNSX);
        for (NSXViewModel nSXViewModel : listNSXView) {
            dtmNSX.addRow(nSXViewModel.todataRow());
        }
    }
    
    private void fill(int index, List<NSX> listNSX) {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        NSX nsx = newNSX();
        JOptionPane.showMessageDialog(this, nsxServiceImpl.themNsx(nsx));
        listNSX = nsxServiceImpl.getAllNSX();
        showData(listNSX);
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (index < 0) {
            ...
            String idNSX = listNSX.get(index).getIdNSX();
            NSX nsx = newNSX();
            JOptionPane.showMessageDialog(this, nsxServiceImpl.updateNSX(nsx, idNSX));
            listNSX = nsxServiceImpl.getAllNSX();
            showData(listNSX);
        }
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (index < 0) {
            ...
            String idNSX = listNSX.get(index).getIdNSX();
            String deleteGHCT = gioHangChiTietImpl.deleteGHCTByNSX(idNSX);
            String deleteHDCT = hoaDonChiTietImpl.deleteHdctByNSX(idNSX);
            String deleteCTSP = chiTietSPServiceImpl.deleteCTSPByIdNSX(idNSX);
            JOptionPane.showMessageDialog(this, nsxServiceImpl.deleteNsx(idNSX));
            listNSX = nsxServiceImpl.getAllNSX();
            showData(listNSX);
        }
